var render = function() {
  ...
  var self = {
		...
		photosVideosTab: Titanium.UI.iOS.createTabbedBar({
  ...
  self.win.add(self.photosVideosTab);
  

  var photoGal = nrequire('/templates/windows/photo_gallery');

  self.win.add(photoGal);
