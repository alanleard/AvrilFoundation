...
@interface AvrilFoundationObject : KrollCoverageObject {
#else
@interface AvrilFoundationObject : KrollObject {
#endif
@private
...
extern NSString * AvrilFoundation$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AvrilFoundationObject *_avrilfoundation;
    KrollObject* console;
	BOOL shutdown;
