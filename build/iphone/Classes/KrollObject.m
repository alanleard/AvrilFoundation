 ...
 * Copyright (c) 2009-2011 by AvrilFoundation, Inc. All Rights Reserved.
...
//@interface AvrilFoundationObject : NSObject
//@end

@interface AvrilFoundationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AvrilFoundationObject class]])
		{
			for (NSString *key in [[(AvrilFoundationObject*)o modules] allKeys])
			{
