...
// in simulator we redefine to format for AvrilFoundation Developer console
...
{\
	NSString * exceptionName = [@"org.avrilfoundation." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avrilfoundation";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAvrilFoundationNativeItemNone = -1, 
	UIAvrilFoundationNativeItemSpinner = -2,
	UIAvrilFoundationNativeItemProgressBar = -3,
	
	UIAvrilFoundationNativeItemSlider = -4,
	UIAvrilFoundationNativeItemSwitch = -5,
	UIAvrilFoundationNativeItemMultiButton = -6,
	UIAvrilFoundationNativeItemSegmented = -7,
	
	UIAvrilFoundationNativeItemTextView = -8,
	UIAvrilFoundationNativeItemTextField = -9,
	UIAvrilFoundationNativeItemSearchBar = -10,
	
	UIAvrilFoundationNativeItemPicker = -11,
	UIAvrilFoundationNativeItemDatePicker = -12,
	
	UIAvrilFoundationNativeItemInfoLight = -13,
	UIAvrilFoundationNativeItemInfoDark = -14,
	
	UIAvrilFoundationNativeItemDisclosure = -15,
	
	UIAvrilFoundationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AvrilFoundation instances of
