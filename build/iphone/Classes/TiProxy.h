...
//Rare exceptions to indicate a bug in the _avrilfoundation code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AvrilFoundation proxies.
 */
