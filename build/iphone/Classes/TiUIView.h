...
/**
 Base class for all AvrilFoundation views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AvrilFoundation view hierarchy (such as wrapped iOS UIViews) was touched.
